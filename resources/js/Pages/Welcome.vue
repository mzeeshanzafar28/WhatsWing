...
<Head title="Welcome" />
    ...
    <body class="bg-gray-900">
        ...
        <header class="bg-gray-900 text-white py-4 px-6 flex justify-between items-center">
            <div>
                <img src="https://media.licdn.com/dms/image/C4D0BAQEHUo_piBLlKQ/company-logo_200_200/0/1670152743360/axon_technologies_pvt_ltd_logo?e=1729123200&v=beta&t=tkplUvHKkOazjtJ7NlP6O-MMI1wj4L_bzlqPIiIciuA"
                    alt="Logo" class="h-8" />
            </div>
            <div>

                <Link href="/login">
                <button class="bg-[#FF2D20] hover:bg-[#E0245E] text-white px-4 py-2 rounded-md mr-2">
                    Log In
                </button>
                </Link>
                <Link href="/register">
                <button class="bg-transparent border border-white text-white px-4 py-2 rounded-md">
                    Sign Up
                </button>
                </Link>
            </div>
        ...
        <div id="about" class="relative bg-gray-900 overflow-hidden mt-16">
            <div class="max-w-7xl mx-auto">
                <div class="relative z-10 pb-8 bg-gray-900 sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                    <svg class="hidden lg:block absolute right-0 inset-y-0 h-full w-48 text-white transform translate-x-1/2"
                        ...
                        <polygon class="bg-gray-900 text-gray-900" points="50,0 100,0 50,100 0,100"></polygon>
                    </svg>

                    <div class="pt-1"></div>

                    <main class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div class="sm:text-center lg:text-left text-white animate__animated animate__jackInTheBox">
                            <span class="block text-6xl font-bold mb-1">WhatsApp</span>
                            <div class="text-6xl text-primary font-bold mb-3">&nbsp;&nbsp; Automation</div>
                            <div class="text-6xl text-primary font-bold mb-3">😉 Made Easy</div>

                            <p class="text-white ">
                                Congrats on making so far! You're in safe hands now 😎. This is WhatsWing! The grand
            ...
            <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
                <img class="h-56 w-full object-cover object-top sm:h-72 md:h-96 lg:w-full lg:h-full"
                    src="https://www.hospitalitynewsmag.com/wp-content/uploads/2023/01/WhatsApp-Business.jpg" alt="">
            </div>
        </div>
                ...
                <div class="grid items-center grid-cols-1 md:grid-cols-2">
                    ...
                    <div>
                        <h2 class="text-3xl font-bold leading-tight text-black dark:text-white sm:text-4xl lg:text-5xl">
                            Hey 👋 This
                            is
                            <br class="block sm:hidden" />WhatsWing
                        </h2>
                        <p class="max-w-lg mt-3 text-xl leading-relaxed text-gray-600 dark:text-gray-300 md:mt-8">
                            ...
                            that simplify everyday tasks. One of our standout creations is <strong>WhatsWing</strong>, a
                            powerful
                        ...
                        <p class="mt-4 text-xl text-gray-600 dark:text-gray-300 md:mt-8">
                            ...
                            <br class="block sm:hidden" /> Ask us on
                            <Link href="#" title=""
        ...
        <!-- call to action  -->
        <div class="py-8 px-4 mx-auto sm:py-16 lg:px-6 bg-gray-800">
            <div class="mx-auto max-w-screen-sm text-center">
                <div class="text-gray-500 font-bold mb-3"><i class="pi pi-discord"></i>&nbsp;POWERED BY AXONTECH</div>
                <h2 class="mb-4 text-5xl tracking-tight font-bold leading-tight text-white">Start your
                    free trial today</h2>
                <p class="mb-6 text-white md:text-lg">Try now. 30-day money-back guarantee</p>


                <Link href="/register"
                    class="inline-flex items-center justify-center px-5 py-3 mr-3 text-base font-medium text-center text-white rounded-lg bg-green-800 hover:bg-green-800 focus:ring-4 focus:ring-green-500 ">
                Get started
        ...
        <div
            class="relative mt-7 isolate flex items-center gap-x-6 overflow-hidden bg-cyan-300 px-6 py-2.5 sm:px-3.5 sm:before:flex-1">
            ...
            <div class="flex flex-wrap items-center gap-x-4 gap-y-2">
                <p class="text-sm leading-6 text-gray-900">
                    <strong class="font-semibold">Hot Deals 🔥</strong><svg viewBox="0 0 2 2"
                        class="mx-2 inline h-0.5 w-0.5 fill-current" aria-hidden="true">
                        <circle cx="1" cy="1" r="1" />
                    </svg>Join us in Denver from August 7 – 9 to see what’s coming next.
                </p>
                <Link href="/register"
                ...
                Register
                now <span aria-hidden="true">&rarr;</span></Link>
            </div>
